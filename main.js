...
global.owner = ['6285974577067'] // Put your number here
global.mods = ['6285974577067'] // Want some help?
global.prems = ['6285974577067'] // Premium user has unlimited limit
...
if (!opts['test']) setInterval(() => {
  ...
  if (JSON.stringify(global.DATABASE.data) == lastJSON) conn.logger.info('Database is up to date')
    ...
    conn.logger.info('Done saving database,YouTube: Devara!')
